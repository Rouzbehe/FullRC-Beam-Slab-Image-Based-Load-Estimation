...
plotfname='classReg/Class-Multi-1T23,51round_Reg-SVM_Case48_20,13,21,50,51,52';
...
testfeatNo=48;%  24=deflectionRatio, 25=V   27=M  28=M/EI  29 =M/bd2 30=M/Asfy   32=M/bh 33=M/bhl 34=M/bdl 35=M/fcbhl 36=M/bh(l-a) or M/bh(l/2)
...
[un idx_last idx1] = unique(pre_without_name,'stable');
...
[un idx_last idx2] = unique(pre_with_name,'stable');
