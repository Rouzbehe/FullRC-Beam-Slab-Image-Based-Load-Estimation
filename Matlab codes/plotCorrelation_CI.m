...
nameFolder='Dec27_8coonectivity-Dec-14';
...
if Plot_No==1
  xlabel('True failure load (KN)','fontsize',size);
  ylabel('Estimated design failure load (KN)','fontsize',size);
...
%   h=ylabel('Predicted scaled moment at mid span ($$\frac{M}{bd^2}$$)','fontsize',sizeLATEX,'FontName','Helvetica','Interpreter','latex');
   xlabel('True scaled moment at mid span  ','fontsize',size);
  ylabel('Predicted scaled moment at mid span ','fontsize',size);  
...
%   ylabel('Predicted  scaled shear $$(V/(2\sqrt{f_c}~bd+A_v~f_y~d/s)$$','fontsize',10,'FontName','Helvetica','Interpreter','latex');
 xlabel('True scaled shear     ','fontsize',size);
 ylabel('Predicted scaled shear     ','fontsize',size);  
  ...
  ylabel('Predicted shear force (kN)','fontsize',size);  
                    ...
                    NameJPG2 = strcat(nameFolder,'/',plotfname,'ConfidenceInterval','indirect_shear force (kN)');
